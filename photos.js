...
function previewFive() {
   ...
   //add appropriate src values to two newe img elements
...
function createEventListeners() {
    ...
    //add an event handler to the specified document when user clicks left nav arrow button
   ...
   //declare variables for element 5 button
   var showAllButton = document.querySelector("#fiveButton p");
   //add evetnt listener, show more button when function is executed
